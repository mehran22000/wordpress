<?php //netteCache[01]000577a:2:{s:4:"time";s:21:"0.73349900 1477405458";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:92:"/Applications/MAMP/htdocs/aslbekhar/wp-content/themes/businessfinder2/parts/post-content.php";i:2;i:1475336605;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.0";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:3:"1.9";}}}?><?php

// source file: /Applications/MAMP/htdocs/aslbekhar/wp-content/themes/businessfinder2/parts/post-content.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'fqhi9d15fg')
;
// prolog NUIMacros
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/item-container", ""), array('layout' => $layout, 'onlyFeaturedCat' => true, 'noFeatured' => $noFeatured) + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ?>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-date-format", ""), array('dateIcon' => $post->rawDate, 'dateLinks' => 'no', 'dateShort' => 'no') + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ?>
								<h2><a href="<?php echo NTemplateHelpers::escapeHtml($post->permalink, ENT_COMPAT) ?>
"><?php echo $post->title ?></a></h2>
<?php if ($post->type == 'post') { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-author", ""), array() + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ;} ?>
...
<?php if ($concreteTaxonomy) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array('taxonomy' => $concreteTaxonomy) + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ;} else { if ($post->isInAnyCategory) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array('taxonomy' => $concreteTaxonomy) + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ;} } ?>
					</footer> --><!-- /.entry-footer -->
				</article>
<?php } ?>
...
<?php if (!$post->hasImage) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ;} ?>
						</div>
...
<?php if ($post->isInAnyCategory) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array() + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ;} ?>

<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ?>
...
<?php if ($post->isInAnyCategory) { ?>
 ...
 <?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array('separator' => ", ") + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ?>
...
<?php if ($post->categoryList) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/entry-categories", ""), array('taxonomy' => 'category') + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ;} NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/comments-link", ""), array() + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ;} ?>
				</div>
...
<?php NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("parts/author-bio", ""), array() + get_defined_vars(), $_l->templates['fqhi9d15fg'])->render() ?>
