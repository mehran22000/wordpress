<?php //netteCache[01]000566a:2:{s:4:"time";s:21:"0.25649400 1477405458";s:9:"callbacks";a:4:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:81:"/Applications/MAMP/htdocs/aslbekhar/wp-content/themes/businessfinder2/@layout.php";i:2;i:1475336604;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:22:"released on 2014-08-28";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:15:"WPLATTE_VERSION";i:2;s:5:"2.9.0";}i:3;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:17:"AIT_THEME_VERSION";i:2;s:3:"1.9";}}}?><?php

// source file: /Applications/MAMP/htdocs/aslbekhar/wp-content/themes/businessfinder2/@layout.php

?><?php
// prolog NCoreMacros
list($_l, $_g) = NCoreMacros::initRuntime($template, 'ig60ad91vv')
;
// prolog NUIMacros
...
<?php NCoreMacros::includeTemplate($elements->unsortable['search-form']->getTemplate(), array('el' => $elements->unsortable['search-form'], 'element' => $elements->unsortable['search-form'], 'htmlId' => $elements->unsortable['search-form']->getHtmlId(), 'htmlClass' => $elements->unsortable['search-form']->getHtmlClass()) + $template->getParameters(), $_l->templates['ig60ad91vv'])->render() ?>
	</div>
<?php } ?>
...
<?php if ($headerLayoutType == 'revslider') { if ($elements->unsortable['revolution-slider']->display) { NCoreMacros::includeTemplate($elements->unsortable['revolution-slider']->getTemplate(), array('el' => $elements->unsortable['revolution-slider'], 'element' => $elements->unsortable['revolution-slider'], 'htmlId' => $elements->unsortable['revolution-slider']->getHtmlId(), 'htmlClass' => $elements->unsortable['revolution-slider']->getHtmlClass()) + $template->getParameters(), $_l->templates['ig60ad91vv'])->render() ;} } elseif ($headerLayoutType == 'map') { if ($elements->unsortable['header-map']->display) { NCoreMacros::includeTemplate($elements->unsortable['header-map']->getTemplate(), array('el' => $elements->unsortable['header-map'], 'element' => $elements->unsortable['header-map'], 'htmlId' => $elements->unsortable['header-map']->getHtmlId(), 'htmlClass' => $elements->unsortable['header-map']->getHtmlClass()) + $template->getParameters(), $_l->templates['ig60ad91vv'])->render() ;} } elseif ($headerLayoutType == 'video') { if ($elements->unsortable['header-video']->display) { NCoreMacros::includeTemplate($elements->unsortable['header-video']->getTemplate(), array('el' => $elements->unsortable['header-video'], 'element' => $elements->unsortable['header-video'], 'htmlId' => $elements->unsortable['header-video']->getHtmlId(), 'htmlClass' => $elements->unsortable['header-video']->getHtmlClass()) + $template->getParameters(), $_l->templates['ig60ad91vv'])->render() ;} } elseif ($headerLayoutType == 'image') { if ($headerImageHeight != "") { ?>
...
<?php if ($elements->unsortable['page-title']->display) { NCoreMacros::includeTemplate($elements->unsortable['page-title']->getTemplate(), array('el' => $elements->unsortable['page-title'], 'element' => $elements->unsortable['page-title'], 'htmlId' => $elements->unsortable['page-title']->getHtmlId(), 'htmlClass' => $elements->unsortable['page-title']->getHtmlClass()) + $template->getParameters(), $_l->templates['ig60ad91vv'])->render() ;} ?>

<?php $currentCategory = get_queried_object() ?>

<?php if ($wp->isTax('items') or $wp->isTax('locations') or $wp->isTax('ait-events-pro')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/taxonomy-category-list", ""), array('taxonomy' => $currentCategory->taxonomy, 'gridMain' => true) + get_defined_vars(), $_l->templates['ig60ad91vv'])->render() ;} elseif ($wp->isPostTypeArchive('ait-item')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/taxonomy-category-list", ""), array('taxonomy' => 'ait-items', 'gridMain' => true) + get_defined_vars(), $_l->templates['ig60ad91vv'])->render() ;} elseif ($wp->isPostTypeArchive('ait-event-pro')) { NCoreMacros::includeTemplate(WpLatteMacros::getTemplatePart("portal/parts/taxonomy-category-list", ""), array('taxonomy' => 'ait-events-pro', 'gridMain' => true) + get_defined_vars(), $_l->templates['ig60ad91vv'])->render() ;} ?>
...
<?php NCoreMacros::includeTemplate($element->getTemplate(), array('el' => $element, 'element' => $element, 'htmlId' => $element->getHtmlId(), 'htmlClass' => $element->getHtmlClass()) + $template->getParameters(), $_l->templates['ig60ad91vv'])->render() ?>
